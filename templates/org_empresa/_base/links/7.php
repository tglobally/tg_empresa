...
<a href="index.php?seccion=org_porcentaje_act_economica&accion=alta&registro_id=<?php echo $controlador->registro_id; ?>&session_id=<?php echo $controlador->session_id; ?>">
