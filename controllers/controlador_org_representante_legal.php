...
class controlador_org_representante_legal extends \gamboamartin\organigrama\controllers\controlador_org_representante_legal {

    public function __construct(PDO $link, stdClass $paths_conf = new stdClass()){

        $html_base = new html();
        parent::__construct( link: $link, html: $html_base, paths_conf: $paths_conf);
        $this->titulo_lista = 'Representante Legal';

        $this->sidebar['lista']['titulo'] = "Representante Legal";
